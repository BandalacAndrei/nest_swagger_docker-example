import {Get, Controller, Post, Body, Param, ParseIntPipe, Delete, Put} from "@nestjs/common";
...
export class CatsController{
    ...
    async update(@Param('id', ParseIntPipe) id: number,@Body() payload: CatCreateDto){
